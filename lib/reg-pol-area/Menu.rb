...
module Menu
  def self.show
	...
	puts "3. Side length and number of sides."
	puts "4. Exit"
  ...
  def self.evalChoice(choice)
	...
	when '2'
	  ...
	  true
	when '3'
	  print "Please input the Side Length> "
	  sideLength = gets.chomp.to_i
	  ...
	  answer = PolyMath.findAreaWithSide(sideLength, sides).to_f
	  answer = answer.round(2)
